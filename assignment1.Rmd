...
Implement and test two of the ensemble learning methods vs bagging & boosting, using C4.5as the base classifier. Train and test, just like the above algorithms, using a 10-fold cross-validation. Compare the performances of bagging and boosting to those of the base classifier C4.
```{r}
#Bagging
...
printf("P-Value: Decision Tree vs Random Forest %.5f",t.test(decision_trees_sonar,random_forest_sonar)$p.value )
printf("P-Value: Decision Tree vs NB %.5f",t.test(decision_trees_sonar,NB_sonar)$p.value)
printf("P-Value: Decision Tree vs SMO %.5f",t.test(decision_trees_sonar,SMO_sonar)$p.value)
printf("P-Value: Decision Tree vs Bagging %.5f",t.test(decision_trees_sonar,bagging_sonar)$p.value)
printf("P-Value: Decision Tree vs Boosting %.5f",t.test(decision_trees_sonar,boosting_sonar)$p.value)
printf("P-Value: Random Forest vs NB %.5f",t.test(random_forest_sonar,NB_sonar)$p.value)
printf("P-Value: Random Forest vs SMO %.5f",t.test(random_forest_sonar,SMO_sonar)$p.value)
printf("P-Value: Random Forest vs Bagging %.5f",t.test(random_forest_sonar,bagging_sonar)$p.value)
printf("P-Value: Random Forest vs Boosting %.5f",t.test(random_forest_sonar,boosting_sonar)$p.value)
printf("P-Value: NB vs SMO %.5f",t.test(NB_sonar,SMO_sonar)$p.value)
printf("P-Value: NB vs Bagging %.5f",t.test(NB_sonar,bagging_sonar)$p.value)
printf("P-Value: NB vs Boosting %.5f",t.test(NB_sonar,boosting_sonar)$p.value)
printf("P-Value: NB vs Bagging %.5f",t.test(SMO_sonar,bagging_sonar)$p.value)
printf("P-Value: NB vs Boosting %.5f",t.test(NB_sonar,boosting_sonar)$p.value)
```
